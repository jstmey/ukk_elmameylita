...
<div class="card shadow">
    ...
    <div class="card-body">
        ...
        require 'koneksi.php';
        $we = $_GET['id'];
        $sql= mysqli_query($con,"select * from pengaduan,tanggapan where tanggapan.id_pengaduan='$we' and
            tanggapan.id_pengaduan=pengaduan.id_pengaduan");
            
        $cek=mysqli_num_rows($sql);
        if ($cek<1)
            {
                echo "<font color='red>Mohon bersabar, pengaduan anda belum di tanggapi</font>";
            }
            else {
