              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome Back!</h1><h6>APLIKASI PENGADUAN MASYARAKAT<h6>
                  </div>
                  <!-- form login -->
                  <form class="user" method="post" action="cek_login.php">
                    ...
                    <input type="submit"  class="btn btn-secondary btn-user btn-block" value="login!">
                    
                  </form>
                  <br>
                  <div class="text-center">
                    Belum punya akun?<br>
                    <a class="small" href="register.php">registrasi sekarang</a>
                  </div>
